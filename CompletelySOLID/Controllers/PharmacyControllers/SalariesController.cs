...
namespace CompletelySOLID.Controllers.PharmacyControllers
{
    ...
    public class SalariesController : ControllerBase
    {
        ...
        {
            return _context.PharmacyContext().Salary;
        }
        ...
        public async Task<IActionResult> GetSalary([FromRoute] int id)
        {
            ...
            var salary = await _context.PharmacyContext().Salary.FindAsync(id);
        ...
        public async Task<IActionResult> PutSalary([FromRoute] int id, [FromBody] Salary salary)
        {
            ...
            _context.PharmacyContext().Entry(salary).State = EntityState.Modified;
        ...
        public async Task<IActionResult> PostSalary([FromBody] Salary salary)
        {
            ...
            _context.PharmacyContext().Salary.Add(salary);
            await _context.PharmacyContext().SaveChangesAsync();
        ...
        {
            return _context.PharmacyContext().Salary.Any(e => e.SalaryId == id);
        }
    }
}